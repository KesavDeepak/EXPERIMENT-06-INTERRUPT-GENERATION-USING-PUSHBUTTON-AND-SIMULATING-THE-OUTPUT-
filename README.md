...
static void MX_GPIO_Init(void)
{
  ...
  // Configure PA9 (Button) as Input with interrupt on Rising edge
  GPIO_InitStruct.Pin = GPIO_PIN_9;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_PULLUP;  // Enable internal pull-up
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

  // Enable EXTI Line interrupt for PA9
...
// ASSERT FAILED (optional debug info)
#ifdef USE_FULL_ASSERT
void assert_failed(uint8_t *file, uint32_t line)
{
  // printf("Wrong parameters: file %s on line %d\r\n", file, line)
}
#endif
...
## Output screen shots of proteus  :
 ![Screenshot 2025-04-17 143217](https://github.com/user-attachments/assets/afbb7720-82b3-4a3a-99cd-1745af6afa8d)

 ![image](https://github.com/user-attachments/assets/619884e3-e8a1-482c-aeb7-4f98c5770eae)

 ## CIRCUIT DIAGRAM (EXPORT THE GRAPHICS TO PDF AND ADD THE SCREEN SHOT HERE): 
 ![New Project1](https://github.com/user-attachments/assets/572a880d-19ee-4fc1-88e5-ea7cdb48aeb7)
